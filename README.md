...
-to create cookies which help users stay logged in thru multiple requests.

1. What does bcrypt do to help us store passwords in a secure manner.
it hashes passwords and compares password inputs from clients to the hashed password saved in the DB during logins.

1. What does bcrypt do to slow down attackers?
even if they gain access to your DB, they still cant read passwords.
